...
_____________________________________________ */
    ...
    socket.on('position', () =>{
        if (player.x ==! player.x -1) {
            console.log("ahora es: ", player.x );
        }else if(player.y ==! player.y -1){
            console.log("ahora es: ", player.y ); //quiero comparar la posición actual con la anterior, pero el tiempo y mi memoria no da.
        }
    })
